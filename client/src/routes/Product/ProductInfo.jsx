...
const ProductInfo = ({ product, user }) => {
    ...
    return (
        <Box>
            <Text mb="20px">{product.category} &#10095; {product.subcategory} </Text>
            <Flex align="start" gap="67px">
                <Flex justify="center" gap="15px">
                    <Flex flexDir="column" gap="8px">
                        {product.images && product.images.slice(0, 9).map((item, index) => {
                            return (
                                <Image
                                    src={item}
                                    key={index}
                                    ...
                                    borderColor={selected === item ? "primary.500" : "rgba(0,0,0,0.2)"}
                                    borderStyle="solid"
                ...
                >
                    ...
                    <Link to="#">
                        <Text textDecorationLine="underline">Visit the {product.shop.name}</Text>
                    </Link>
                    <HStack spacing="1">
                        <Star />
                        <Star />
                    ...
                    >
                        {product.shop.delivery_places.includes(user.place) ?
                            (<>
                                <Icon mt="-5px" as={Delivery} fill="primary.500" h="40px" w="50px" />
                                <Text as="p">
                            ...
                            :
                            (<>
                                <Icon mt="-5px" as={Delivery} fill="dark.100" h="40px" w="50px" />
                                <Text as="p">
